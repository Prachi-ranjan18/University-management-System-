...
public class TeacherDetails extends JFrame implements ActionListener{
    ...
    JButton b1,b2,b3;
    JTextField t2;
    String x[] = {"Name","Father's Name","Age","Date of Birth","Address","Phone","Email","Class X(%)", "Class XII(%)", "Aadhar No","Course","Department", "Employee Id","Higher Education(%)"};
    ...
    TeacherDetails(){
        ...
        try{
            ...
            while(rs.next()){
                ...
                y[i][j++]=rs.getString("adhar_no");
                y[i][j++]=rs.getString("higher_education");
                y[i][j++]=rs.getString("department_issued");
                y[i][j++]=rs.getString("emp_id");
                y[i][j++]=rs.getString("higher_education_percentage");
                i++;
                j=0;
            }
            t1 = new JTable(y,x);
