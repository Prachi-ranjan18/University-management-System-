...
public class AboutUs extends JFrame{
	...
	private JPanel contentPane;
        ...
        public AboutUs() {
            ...
            super("About Us - Kurukshetra University, Kurukshetra");
            ...
            l1 = new JLabel(i3);
            l1.setBounds(400, 40, 290, 100);
            contentPane.add(l1);


            JLabel l3 = new JLabel("Kurukshetra University");
            l3.setForeground(new Color(0, 250, 154));
            l3.setFont(new Font("Trebuchet MS", Font.BOLD | Font.ITALIC, 34));
            l3.setBounds(50, 40, 380, 55);
            contentPane.add(l3);
...
//            contentPane.add(l7);
            ...
            JLabel l8 = new JLabel("Mail Us : kuk@gmail.com");
            l8.setFont(new Font("Trebuchet MS", Font.BOLD, 20));
            l8.setBounds(70, 370, 600, 34);
            contentPane.add(l8);
...
//            contentPane.add(l9);
            ...
            JLabel l10 = new JLabel("Contact Us : +91 8877845938");
