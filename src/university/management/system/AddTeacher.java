...
class AddTeacher implements ActionListener{
    ...
    JFrame f;
    JLabel id,id1,id2,id3,id4,id5,id6,id7,id8,id9,id10,id11,id12,id15,id16,id17,lab,lab1,lab2,id20;
    ...
    AddTeacher(){
        ...
        lab=new JLabel("Higher Education");
        lab.setBounds(50,400,150,30);
	lab.setFont(new Font("serif",Font.BOLD,20));
        id15.add(lab);
            
        String course[] = {"B.Tech","M.Tech","BBA","BCA","Bsc","Msc","MBA","MCA","BA","BCom"};
        ...
        id20= new JLabel("Higher Ed.(%)");
        id20.setBounds(50,450,150,30);
        id20.setFont(new Font("serif",Font.BOLD,20));
        id15.add(id20);

        t20=new JTextField();
        t20.setBounds(200,450,150,30);
        id15.add(t20);
        
        lab2=new JLabel("Department Issued");
        lab2.setBounds(400,400,180,30);
    ...
    public void actionPerformed(ActionEvent ae){
        ...
        if(ae.getSource() == b){
            try{
                conn cc = new conn();
                String q = "insert into teacher values('"+a+"','"+bb+"','"+c+"','"+d+"','"+e+"','"+ff+"','"+g+"','"+h+"','"+i+"','"+j+"','"+k+"','"+m+"','"+l+"','"+n+"')";
